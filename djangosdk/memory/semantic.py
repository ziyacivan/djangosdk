...
class SemanticMemory(AbstractMemoryStore):
    ...
    Required ORM model (add to djangosdk/models/ and create a migration)::

        # djangosdk/models/semantic_memory_entry.py
        import uuid
    ...
    def _get_model(self):
        from djangosdk.models.semantic_memory_entry import SemanticMemoryEntry
