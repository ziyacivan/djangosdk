...
from djangosdk.testing.mock_litellm import MockLiteLLMImage, MockLiteLLMAudio
...
class TestGenerateImage:
    ...
    async def test_agenerate_image(self):
        from djangosdk.images.generate import agenerate_image
...
class TestTranscribe:
    ...
    async def test_atranscribe(self):
        from djangosdk.audio.transcribe import atranscribe
...
class TestSynthesize:
    ...
    async def test_asynthesize(self):
        from djangosdk.audio.synthesize import asynthesize
